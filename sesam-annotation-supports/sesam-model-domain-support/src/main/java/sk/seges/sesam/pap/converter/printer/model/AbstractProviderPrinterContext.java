 ...
 */
public abstract class AbstractProviderPrinterContext {
    ...
    public AbstractProviderPrinterContext(DtoDeclaredType dtoType, ConfigurationTypeElement configurationType) {
        this.rawDomain = dtoType.getDomain();
    ...
    public AbstractProviderPrinterContext(DomainDeclaredType domainType) {
    ...
    protected AbstractProviderPrinterContext(DomainDeclaredType rawDomain, DomainDeclaredType domain, DtoDeclaredType rawDto,
